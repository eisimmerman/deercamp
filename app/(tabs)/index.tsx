...
let hasShownLaunchIntroThisSession = false;
...
export default function HomeScreen() {
  ...
  React.useEffect(() => {
    ...
    if (hasShownLaunchIntroThisSession) {
      setShowIntro(false);
      introOpacity.setValue(0);
      return undefined;
    }

    hasShownLaunchIntroThisSession = true;
    setShowIntro(true);
    introOpacity.setValue(1);
  ...
  return (
    <View style={styles.screen}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerText}>
            Capture camp memories and field stats with simple taps. DeerCamp
            handles saving, syncing, and posting behind the curtain.
          </Text>
        </View>
      ...
      {showIntro && (
        ...
        >
          <Image
            source={require("../../images/deercamp_app_splash_screen_design.png")}
            style={styles.introArtwork}
            resizeMode="cover"
            accessibilityLabel="DeerCamp CampFieldApp branded splash screen"
          />
        </Animated.View>
      )}
    </View>
