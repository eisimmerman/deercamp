...
function buildStewardSetupLink(payload = {}) {
  ...
  const campName = firstNonEmpty(payload.campName, getCampName(payload));
...
function buildEmailCopy(payload = {}) {
  ...
  const ctaWithCamp = campName ? `Continue Your Saved DeerCamp — ${campName}` : 'Continue Your Saved DeerCamp';
